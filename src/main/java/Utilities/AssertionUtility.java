...
public class AssertionUtility {
    ...
    public static class HardAssertionUtility {
        ...
        public static void assertElementText(WebDriver driver, By locator, String expectedText) {
            ...
            Assert.assertEquals(actualText, expectedText, "Text should be: " + expectedText + " but was: " + actualText);
        }

        public static void assertElementTextContaining(WebDriver driver, By locator, String expectedText) {
            WebElement element = driver.findElement(locator);
